...
class NaiveBayes:
    def __init__(self, alpha = 1,prior_prob = None, conditional_prob = None, num_of_cat = None ):
...
##      label : the dimension in label is N * 1.
##      
